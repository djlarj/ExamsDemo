...
// Quiz Data: Generate 10 multiplication problems (7–12 times tables)
const quizData = [];

for (let i = 0; i < 10; i++) {
  const num1 = Math.floor(Math.random() * 6) + 7; // 7–12
  ...
  while (distractors.size < 3) {
    ...
    if (method === 0) {
      ...
      // Another random multiplication from 7–12 × 0–12
      const altNum1 = Math.floor(Math.random() * 6) + 7;
